...
public class MonsterCreatorActivity extends Activity {
    ...
    /*
    * 2a) Track that the user visited the monster edit page (call event "monster_edit")
    * on the MonsterCreatorActivity
    * */
    private void logActivityEvent() {
        //Track user visited the monster edit page (monster_edit)
        BranchEvent branchEvent = new BranchEvent("monster_edit");
        branchEvent.logEvent(MonsterCreatorActivity.this);
    }
