...
public class MonsterObject implements Parcelable {
    ...
    //converting monsterObj to branchObj for logging and setting short url
    public BranchUniversalObject convertToBranchObj() {
        BranchUniversalObject branchUniversalObject = new BranchUniversalObject();
        branchUniversalObject.setTitle(String.format("Branchster Name: %s", monsterName));
        branchUniversalObject.setContentDescription(monsterDescription);
        branchUniversalObject.setContentImageUrl(getMonsterImage());

        ContentMetadata contentMetadata = new ContentMetadata();
        contentMetadata.addCustomMetadata("monster", "true");
        contentMetadata.addCustomMetadata("monster_name", monsterName);
        contentMetadata.addCustomMetadata(MonsterPreferences.KEY_COLOR_INDEX, "" + colorIndex);
        contentMetadata.addCustomMetadata(MonsterPreferences.KEY_BODY_INDEX, "" + bodyIndex);
        contentMetadata.addCustomMetadata(MonsterPreferences.KEY_FACE_INDEX, "" + faceIndex);
