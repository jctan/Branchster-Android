Branchster-Android
==================
## Direction to Install and Running the App
- You can download and install the app-release.apk file from the app/release folder.
- You can use adb for installing the app-release.apk file using the following command:
    - adb install -r app-release.apk

- If the branchster app already installed and you want to re-install it, please uninstall it using the following command:
    - adb uninstall io.branch.branchster
    - adb install -r app-release.apk (install again)
